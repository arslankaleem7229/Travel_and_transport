        ...
        <div class="menuBar"onmouseover="changeColor()" onmouseout="defaultColor()" onclick="toggleButton(this), showMenu()"  >
         ...
         <a> <div class="homeIcon">  <i class="fa fa-road" ></i></div></a>
            <div class = "header">            
        ...
        <a id="img"><p class="preventTextSelection" unselectable="on" onselectstart="return false;"onmousedown="return false;"><i class="fa fa-road"></i></p></a>
