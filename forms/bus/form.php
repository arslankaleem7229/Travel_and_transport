<?php include(($_SERVER['DOCUMENT_ROOT']. "/travel_and_transport/forms/bus/insert.php"));?> <div class="form"
    Style="width:100%">
    <div id="left" Style="width:36%;height:650px;padding:0px;">
        <p Style="margin-top:0px;text-align:center;font-size:70px;color: #ff4d4d;opacity:0.7;">
            A<br>D<br>D<br>B<br>U<br>S</p>
    </div>
    <div id="right" Style="width:64%;height:650px;">
        <form action="/travel_and_transport/forms/bus/insert.php" method="post">
            ...
            <p>BUS NUMBER:</p>
            <input type='text' placeholder="e.g.AB-0234" name='number' id="number" value=""
                onblur='SC._VALIDATE_FIELD_FORMAT(this)'>
            <label style="color:red;font-size:20px;">&#10003;</label>
            <p>DRIVER NAME:</p>
            <input type='text' placeholder="e.g.AB-0234" name='drivername' id="drivername" value=""
