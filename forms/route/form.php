...
<?php include(($_SERVER['DOCUMENT_ROOT']. "/travel_and_transport/forms/route/insert.php"));?>
    <div class="form" Style="width:96%">
    <div id="left" Style="width:36%;height:650px;padding:0px;"> <p Style="margin-top:0px;text-align:center;font-size:70px;color: #ff4d4d;opacity:0.7;">R<br>O<br>U<br>T<br>E</p></div>
    
    
    
  <div id="right" Style="width:64%;height:650px;"><form action="/travel_and_transport/forms/route/insert.php" method="post">
