...
<html>
    ...
    <body>
      <?php include($_SERVER['DOCUMENT_ROOT']. "/travel_and_transport/includes/themegeneral.php")?>
        <div class="body" Style="width:90%;height:700px;" >
            <h1 Style="font-family:moodyrock;font-size:70px;">Account Created.</h1>
            <form action="/travel_and_transport/index.php">
            <br><br>
            <div>
