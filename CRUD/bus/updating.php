...
<?php include($_SERVER['DOCUMENT_ROOT'] . "/travel_and_transport/includes/connection.php")?>
    ...
    <div id="right" Style="width:64%;height:650px;"><form action="/travel_and_transport/CRUD/bus/update.php" method="post">
      <?php
           $ID=$_GET['id'];
  ...
  <p> ROUTE: </p>
     <span> FROM
      ...
      <p>BUS NUMBER:</p>
    <input type='text' placeholder="e.g.AB-123" name='number' id="number" value="" onblur='SC._VALIDATE_FIELD_FORMAT(this)'> 
      <label style="color:red;font-size:20px;">&#10003;</label> 
       <p>LICENSE:</p>
    <input type='text' placeholder="e.g.AB-123" name='license' id="license" value="" onblur='SC._VALIDATE_FIELD_FORMAT(this)'> 
      <label style="color:red;font-size:20px;">&#10003;</label> 
