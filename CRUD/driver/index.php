...
<div class="selectQuries"><form method="post" action="travel_and_transport/index.php">
    ...
    <table>
        ...
        <tr id="header">
            <td colspan='3' ><h1 Style="margin-top:-30px;font-size:40px;height:0px;">MANAGE DRIVER</h1></td>
        </tr>
       
        <tr id="singleLink">
            <td><a href="\travel_and_transport\forms\driver">INSERT A DRIVER</a></td>
            <td><a href="\travel_and_transport\CRUD\driver\searchquery.php">SEARCH A DRIVER</a></td>
<!--            <td><a href="#">TODAY'S INCOME</a></td>-->
        </tr>
        <tr id="singleLink">
            <td><a href="\travel_and_transport\CRUD\driver\updatequery.php">UPDATE DRIVER INFO</a></td>
            <td><a href="\travel_and_transport\CRUD\driver\deletequery.php">DELETE A DRIVER</a></td>
<!--            <td><a href="#">TODAY'S INCOME</a></td>-->
        </tr>
