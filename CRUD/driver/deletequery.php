...
<div class="manage">
     <div id="right" Style="width:100%;height:100px;"><form action="\travel_and_transport\CRUD\driver\delete.php" method="post">
    <table>
       
        <tr>
            <td colspan="10" Style="text-align:center;font-size:16px;">DELETE DRIVER INFO<br>
