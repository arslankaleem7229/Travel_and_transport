...
<div class="manage">
     <div id="right" Style="width:100%;height:100px;"><form action="\travel_and_transport\CRUD\route\search.php" method="post">
    <table>
       
        <tr>
            <td colspan="10" Style="text-align:center;font-size:16px;">FIND ROUTE INFO<br>
                    <form method="post" action="\travel_and_transport\CRUD\route\search.php">
